...
class Node {
  ...
  depthFirstSearch(array) {
    ...
    // traverse the tree (starting at the root node, "this")
    // 1. store its name in 'array'
    // 2. explore its child nodes (each node in this.children array)
    // 3. to process them the same way
