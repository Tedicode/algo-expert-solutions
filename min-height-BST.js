function minHeightBst(array, root = null) {
  ...
  // recurse on left and right, using these arrays, and assigning their roots
  // to the left child and right child
  ...
  minHeightBst(leftArr, root);
  minHeightBst(rightArr, root);
...
// in the worst case and logn in average case
...
// BUT we are creating a BST of n nodes,
